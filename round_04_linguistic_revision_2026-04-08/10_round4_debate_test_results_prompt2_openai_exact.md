...
Conditions: `plain_english`, `RCCE-1`, `ATRCE-2`
...
**plain_english**: 84 avg internal tokens (baseline); compliance 100%; repair turns 0; final quality 2
Run token counts: `[84, 84, 84]`
Internal sample:
```text
...
**RCCE-1**: 91 avg internal tokens (-8.3% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[91, 91, 91]`
Internal sample:
```text
...
**ATRCE-2**: 90 avg internal tokens (-7.1% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
...
**plain_english**: 67 avg internal tokens (baseline); compliance 100%; repair turns 1; final quality 3
...
**RCCE-1**: 80 avg internal tokens (-19.4% lower internal token cost vs plain_english); compliance 100%; repair turns 1; final quality 3
...
**ATRCE-2**: 82 avg internal tokens (-22.4% lower internal token cost vs plain_english); compliance 100%; repair turns 1; final quality 3
...
**plain_english**: 70 avg internal tokens (baseline); compliance 100%; repair turns 0; final quality 3
...
**RCCE-1**: 79 avg internal tokens (-12.9% lower internal token cost vs plain_english); compliance 100%; repair turns 1; final quality 3
...
**ATRCE-2**: 83 avg internal tokens (-18.6% lower internal token cost vs plain_english); compliance 100%; repair turns 1; final quality 3
Run token counts: `[83, 83, 83]`
Internal sample:
```text
CLAIM: id=c1; topic=fallback; content=protocol should be default
...
**plain_english**: 76 avg internal tokens (baseline); compliance 100%; repair turns 0; final quality 2
Run token counts: `[76, 76, 76]`
Internal sample:
```text
...
**RCCE-1**: 90 avg internal tokens (-18.4% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[90, 90, 90]`
Internal sample:
```text
...
**ATRCE-2**: 82 avg internal tokens (-7.9% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[82, 82, 82]`
Internal sample:
```text
CLAIM: id=c1; topic=scope; content=start narrow for comparability
...
**plain_english**: 72 avg internal tokens (baseline); compliance 100%; repair turns 0; final quality 3
...
**RCCE-1**: 83 avg internal tokens (-15.3% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[83, 83, 83]`
Internal sample:
```text
...
**ATRCE-2**: 80 avg internal tokens (-11.1% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[80, 80, 80]`
Internal sample:
```text
...
**RCCE-1**: 86 avg internal tokens (-2.4% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[86, 86, 86]`
Internal sample:
```text
...
**ATRCE-2**: 85 avg internal tokens (-1.2% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[85, 85, 85]`
Internal sample:
```text
...
**plain_english**: 77 avg internal tokens (baseline); compliance 100%; repair turns 0; final quality 2
...
**RCCE-1**: 91 avg internal tokens (-18.2% lower internal token cost vs plain_english); compliance 100%; repair turns 1; final quality 2
Run token counts: `[91, 91, 91]`
Internal sample:
```text
...
**ATRCE-2**: 95 avg internal tokens (-23.4% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[95, 95, 95]`
Internal sample:
```text
CLAIM: id=c1; topic=plan; content=refactor parser and validator before release
...
|---|---|---:|---:|---:|---:|
| protocol_rule_proposal | plain_english | 84 | 100% | 0 | 2 |
| protocol_rule_proposal | RCCE-1 | 91 | 100% | 0 | 2 |
| protocol_rule_proposal | ATRCE-2 | 90 | 100% | 0 | 2 |
| missing_evidence_repair | plain_english | 67 | 100% | 1 | 3 |
| missing_evidence_repair | RCCE-1 | 80 | 100% | 1 | 3 |
| missing_evidence_repair | ATRCE-2 | 82 | 100% | 1 | 3 |
| fallback_trigger | plain_english | 70 | 100% | 0 | 3 |
| fallback_trigger | RCCE-1 | 79 | 100% | 1 | 3 |
| fallback_trigger | ATRCE-2 | 83 | 100% | 1 | 3 |
| benchmark_scope_decision | plain_english | 76 | 100% | 0 | 2 |
| benchmark_scope_decision | RCCE-1 | 90 | 100% | 0 | 2 |
| benchmark_scope_decision | ATRCE-2 | 82 | 100% | 0 | 2 |
| reference_clarity | plain_english | 72 | 100% | 0 | 3 |
| reference_clarity | RCCE-1 | 83 | 100% | 0 | 2 |
| reference_clarity | ATRCE-2 | 80 | 100% | 0 | 2 |
| scope_expansion | plain_english | 84 | 100% | 0 | 2 |
| scope_expansion | RCCE-1 | 86 | 100% | 0 | 2 |
| scope_expansion | ATRCE-2 | 85 | 100% | 0 | 2 |
| human_interrupt_during_execution | plain_english | 77 | 100% | 0 | 2 |
| human_interrupt_during_execution | RCCE-1 | 91 | 100% | 1 | 2 |
| human_interrupt_during_execution | ATRCE-2 | 95 | 100% | 0 | 2 |
| **TOTAL / AVG** | plain_english | **530** | **100%** | **0.1** | **2.4** |
| **TOTAL / AVG** | RCCE-1 | **600** | **100%** | **0.4** | **2.3** |
| **TOTAL / AVG** | ATRCE-2 | **597** | **100%** | **0.3** | **2.3** |

## Verdict

`RCCE-1` reduced average internal coordination token cost by -13.2% vs `plain_english`.
Average compliance: 100%; average repair turns: 0.4; average final quality: 2.3.
Average savings per 7-case suite: -70 internal tokens.
Scale-up estimate: -700 tokens saved across 10 suites, -7000 across 100 suites, -70000 across 1000 suites.
These counts use the configured OpenAI tokenizer directly; apply model-specific pricing separately if needed.
`ATRCE-2` reduced average internal coordination token cost by -12.6% vs `plain_english`.
Average compliance: 100%; average repair turns: 0.3; average final quality: 2.3.
Average savings per 7-case suite: -67 internal tokens.
Scale-up estimate: -670 tokens saved across 10 suites, -6700 across 100 suites, -67000 across 1000 suites.
These counts use the configured OpenAI tokenizer directly; apply model-specific pricing separately if needed.