...
**ATRCE-2**: 56 avg internal tokens (39.1% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
...
**ATRCE-2**: 46 avg internal tokens (36.1% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 3
Run token counts: `[46, 46, 46]`
Internal sample:
```text
CLAIM: id=c1; topic=schema-size; content=small fixed schemas improve reliability
...
**ATRCE-2**: 52 avg internal tokens (26.8% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 3
Run token counts: `[52, 52, 52]`
Internal sample:
```text
CLAIM: id=c1; topic=fallback; content=protocol should be default
...
**ATRCE-2**: 47 avg internal tokens (42.7% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[47, 47, 47]`
Internal sample:
```text
CLAIM: id=c1; topic=scope; content=start narrow for comparability
...
**ATRCE-2**: 50 avg internal tokens (36.7% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[50, 50, 50]`
Internal sample:
```text
...
**ATRCE-2**: 51 avg internal tokens (43.3% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[51, 51, 51]`
Internal sample:
```text
...
**ATRCE-2**: 60 avg internal tokens (14.3% lower internal token cost vs plain_english); compliance 100%; repair turns 0; final quality 2
Run token counts: `[60, 60, 60]`
Internal sample:
```text
CLAIM: id=c1; topic=plan; content=refactor parser and validator before release
...
Average savings per 7-case suite: 172 internal tokens.
Scale-up estimate: 1720 tokens saved across 10 suites, 17200 across 100 suites, 172000 across 1000 suites.
Claude Sonnet 4 output-cost guideline: about $0.002580 saved per 7-case suite, using $15 per million output tokens.
`ATRCE-2` reduced average internal coordination token cost by 34.9% vs `plain_english`.
Average compliance: 100%; average repair turns: 0; average final quality: 2.3.
Average savings per 7-case suite: 194 internal tokens.
Scale-up estimate: 1940 tokens saved across 10 suites, 19400 across 100 suites, 194000 across 1000 suites.
Claude Sonnet 4 output-cost guideline: about $0.002910 saved per 7-case suite, using $15 per million output tokens.